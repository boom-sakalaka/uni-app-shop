<template>
  <view class="wrap">
    ...
    <view class="content">
      ...
      <input
        class="u-border-bottom u-m-b-40"
        type="password"
        v-model="password"
        placeholder="请输入密码"
        :focus="isFocus"
        ...
        @confirm="submit"
      />
      <button :loading="submitBtn" :disabled="submitBtn" @click="submit" :style="[inputStyle]" class="getCaptcha">
        登录
      </button>
      <view class="alternative">
        <view class="issue" @tap="jump('pages/author/register')">注册</view>
      </view>
    </view>
  </view>
</template>
